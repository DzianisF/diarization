...
const translations: Record<string, string> = {
  ...
  "Start it first:": "Сначала запустите:", "in the repository folder, open a terminal and run": "в папке репозитория откройте терминал и выполните", "Keep that terminal open. If the browser asks to access the local network, choose Allow.": "Не закрывайте это окно терминала. Если браузер запросит доступ к локальной сети, разрешите его.",
